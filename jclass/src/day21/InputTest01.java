...
public class InputTest01 {
	 ...
	 */
		...
		try {
			...
			ch =System.in.read();
			//출력
			System.out.println("입력한문자1: " +(char)ch);
			System.out.println("입력한문자2: " +ch);
			*/
			...
			//이때 256이라고 입력하는 부분의 숫자에 따라서 한벙에 읽을 데이터의 양이 결정된다.
			...
			*/
			...
			/*
			 * 준비된 배열 buff에 10번방부터 읽은 내용을 기억하세요
			 * 최대 100개 까지만 읽으세요(100자만 입력받는다.)
			 */
